    ...
    *,
    ...
    with closing(sqlite3.connect(work_db)) as db:
        ...
        meta = {
            ...
            "definitions_revision": str(definitions_index.get("definitionsRevision") or ""),
            "definitions_scanner_revision": str(definitions_index.get("scannerRevision") or ""),
            "definitions_scanner_bundle_sha256": str((definitions_index.get("scannerBundle") or {}).get("sha256") or ""),
            "definitions_artifact_analysis_revision": str(definitions_index.get("artifactAnalysisRevision") or ""),
            "definitions_source_analysis_revision": str(definitions_index.get("sourceAnalysisRevision") or ""),
            "definitions_source_observation_revision": str(definitions_index.get("sourceObservationRevision") or ""),
