...
internal static partial class RegressionCases
{
    internal static void TestPluginSecurityIntelligenceContract()
    {
        ...
        Contains(normalizedWorkflow, "git checkout --detach", "scanner code is pinned to the exact frozen Definitions source commit");
        Contains(normalizedWorkflow, "definitions_snapshot.py verify", "frozen Definitions are verified against the pinned scanner code before use");
        Contains(normalizedWorkflow, "catalog_json_store.py materialize", "worker materializes its relational scan input from canonical JSON");
        ...
        Contains(normalizedWorkflow, "--definitions-source-commit", "scan provenance records the exact frozen source commit");
