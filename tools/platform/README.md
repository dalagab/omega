...
The output is `omega.platform-support.v1` and always carries Windows, Linux and macOS records. Statuses are evidence-based (`verified-in-rift`, `blocked-in-rift`, `packaged-unverified`, `platform-dependent-unverified`, `unknown`) rather than a guessed boolean.
