...
EXECUTIONS: tuple[dict[str, Any], ...] = ({'id': 'source-discovery',
 ...
 {'id': 'advisory-collector',
  ...
  'docs': 'collectors',
  'componentId': 'omega.sigmascope'},
 {'id': 'external-analysis-sources',
  'title': 'External analyzer research-source observer',
  'workflow': 'external-analysis-worker.yml',
  'job': 'Collect leased external-analysis source working state',
  'step': 'Observe license-gated research-source HEAD revisions',
  'purpose': 'Refresh the external analyzer research-source registry and observe only license-allowed public source HEADs; restricted sources remain metadata-only and never become runtime rule feeds.',
  'inputs': ['external-analysis registry', 'public GitHub repository heads for automated-safe sources'],
  'outputs': ['frozen external-analysis source observation document'],
  'implementation': 'tools/security/external_analysis_sources.py + tools/orchestration/work_result.py',
  'cadenceMode': 'scheduled',
  'docs': 'collectors',
  'componentId': 'omega.sigmascope'},
