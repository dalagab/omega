...
internal static partial class RegressionCases
{
    ...
    internal static void TestDiscoverStoreListContract()
    {
        ...
        Contains(product, "Math.Min(Ui(ProductHeroMaxWidth), ImGui.GetContentRegionAvail().X)", "product hero remains responsive when the content pane is narrower than its preferred width");
        ...
        Contains(product, "new Vector4(0.045f, 0.052f, 0.064f, 0.74f)", "product metadata remains on a translucent hero panel above the banner");
