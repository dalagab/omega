...
/* DeltaScope 4.13.2 usability fixes: rendered docs, clickable rule collections, compact rail collapse,
...
class AppHandler(BaseHTTPRequestHandler):
    inspector: Any
    server_version = "OmegaDeltaScope/4.13.2"
