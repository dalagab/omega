...
class WorkflowContractTests(unittest.TestCase):
    ...
    def test_catalog_builder_is_explicit_authoritative_freeze_without_client_publication(self) -> None:
        ...
        self.assert_has(
            ...
            "--external-analysis-input catalog/lane-results/external-analysis-sources/external-analysis-sources.json",
    ...
    def test_revision_and_v2_publication_tools_are_separated_by_workflow(self) -> None:
        ...
        self.assertIn("Verify published customer release", customer)
        self.assertIn("gh release download catalog-latest", customer)
        self.assertIn("cmp -s catalog/client-dist/catalog.json", customer)
